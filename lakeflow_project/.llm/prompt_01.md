...
Declarative Pipeline dentro deste bundle. Use sempre o perfil de CLI "default".

CONTEXTO
- Todo o trabalho acontece no catálogo ecommerce. Nunca use outro catálogo.
- A bronze já existe e é sobrescrita por outra ingestão: ecommerce.bronze.vendas,
...
- Catálogo ecommerce, schemas bronze, silver e gold.
...
- Crie o notebook testes/testes_qualidade.py (formato source do Databricks, widget catalogo com
  padrão ecommerce). Cada teste é uma consulta que conta linhas com problema; se alguma achar,
